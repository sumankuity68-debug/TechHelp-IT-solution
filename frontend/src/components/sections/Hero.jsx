...
// Landing page hero section with 3D Parallax graphics, Theme support + Framer Motion animations
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        {/* Left Column — animates in on load */}
        <motion.div
          style={{ zIndex: 2 }}
        ...
        {/* Right Column: 3D Parallax Visuals — slide in from right */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <div style={{ width: '100%', height: 4, background: 'var(--border-color)', borderRadius: 2, marginTop: 16, overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            position: 'absolute', top: '15%', left: '10%', pointerEvents: 'none',
          }} />
          <div style={{
