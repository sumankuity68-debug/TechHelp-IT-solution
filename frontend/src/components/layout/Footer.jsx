...
export default function Footer() {
  ...
  const socialLinks = [
    {
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/suman-kuity-a7a77a324/',
      icon: (
    ...
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/suman_kuity68/',
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 20 }}>
              <a
                href="mailto:sumakuity68@gmail.com"
                style={{
              ...
              >
                ...
                sumakuity68@gmail.com
              </a>
              <a
                href="tel:+919883633066"
                style={{
                  display: 'flex', alignItems: 'center', gap: 10,
                  color: 'var(--text-secondary)', textDecoration: 'none',
                  fontSize: 13, transition: 'color 0.2s',
